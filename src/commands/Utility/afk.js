    ...
    try {
      ...
      if (!data) {
        ...
        const replyMessage = new EmbedBuilder()
          ...
          .setDescription(
            `\`✅\` I have set you AFK${
              reasonInput ? ` with the reason: **${reasonInput}**` : ""
            }`
          )
          .setTimestamp();
        ...
        const alreadyAfkMessage = new EmbedBuilder()
          ...
          .setDescription(
            `\`❌\` You already set yourself AFK. To stop this from happening, send a message in any channel!`
          )
          .setTimestamp();
      ...
      const errorMessage = new EmbedBuilder()
        .setColor(client.config.embedError)
        .setDescription(
          `\`❌\` An error occurred while setting you AFK. Please try again later.`
        )
        .setTimestamp();
